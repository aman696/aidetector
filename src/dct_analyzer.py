...
def dct_score(image_path: str) -> float:
    ...
    # Kurtosis: empirically measured range on this dataset is 100–300.
    # AI images have HIGHER kurtosis (heavier tails) than real images.
    # real_camera ≈ 159, ai_generated ≈ 236 — so higher = more AI-like.
    # Map [100, 300] → [0.0, 1.0].
    kurtosis = features['dct_coeff_kurtosis']
    kurt_score = np.clip((kurtosis - 100.0) / 200.0, 0.0, 1.0)
